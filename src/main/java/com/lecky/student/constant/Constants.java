...
public class Constants {
	...
	public static final String STATUS_NOTNULL_MESSAGE = STATUS_JSON_PROPERTY + " no debe ser nulo";

	public static final String AGE_JSON_PROPERTY = "edad";
	public static final String AGE_NOTNULL_MESSAGE = AGE_JSON_PROPERTY + " no debe ser nulo";
